...
def success():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            coordinates = [test(address) for address in addresses]
            ...
            result = df.to_html(classes="table table-bordered table-hover w-auto", index=False)
